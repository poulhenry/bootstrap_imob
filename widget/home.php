<div class="main_slide">
    <div class="container" style="height: 100%">
        <div class="row align-items-center" style="height: 100%">
            <div class="col-8">
                <p class="main_slide_content">Encontre o <b>imóvel ideal</b> para <b>sua família</b> morar na praia!</p>
...
<section class="main_list_group py-5 bg-light">
    <div class="container text-center">
        <div class="p-4 border-bottom border-front">
            <h1>Ambiente em seu <span class="text-front"><b>estilo</b></span></h1>
            <p class="text-center text-muted h4">Encontre o imovel com a expieriencia quer viver</p>
        </div>
...
<section class="main_properties py-5">
    <div class="container">
        <div class="border-bottom d-flex justify-content-between align-items-center border-front mb-5">
            ...
            <article class="col-4">
                <div class="card main_properties_item">
                    ...
                    <div class="card-body">
                        ...
                        <p class="main_properties_item_category">Imóvel Residencial</p>
                        <p class="main_properties_item_type">Apartamento - Campeche <i class="icon-location-arrow"></i></p>
                        <p class="main_properties_item_price text-front">R$ 400.000,00/mês</p>
                        <a class="btn btn-front btn-block" href="">Ver Imóvel</a>
                    </div>
                    <div class="card-footer text-muted d-flex">
                        <div class="col-4 main_properties_item_features text-center">
